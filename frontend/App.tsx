...
import { BarChart3, Home, FileText, Activity, Goal, GitBranch, CheckCircle, BarChart, Monitor } from 'lucide-react';
...
export default function App() {
  const [activeScreen, setActiveScreen] = useState('Главная');
  ...
  return (
    <div className="size-full flex bg-neutral-50">
      ...
      {activeScreen === 'Главная' && <GlavnayaScreen />}
