...
## 4. Проекты 
Представляется в виде: [Название] + [Статус (план, в работе, приостановлен, завершен)] + [Дата начала] + [Дата окончания] + [Трудоемкость Аналитики/Разработчики/Тестировщики (чел.час)] + [Зависимости от других проектов] + [Ограничения] + [Текущие отклонения]

Используется: 
- на странице Анализ
- на странице Цели
- на странице Альтернативы
- на станице План
